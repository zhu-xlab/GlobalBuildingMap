...
class GatedGraphConvolutionNeuralNetwork(nn.Module):
    def __init__(self, adj, hidden_size, num_edge_types, layer_timesteps,
                 residual_connections,
                 state_to_message_dropout=0.3,
                 rnn_dropout=0.3,
                 use_bias_for_message_gcn=True):

        super(GatedGraphConvolutionNeuralNetwork, self).__init__()
        ...
        self.use_bias_for_message_gcn = use_bias_for_message_gcn
    ...
    def compute_node_representations(self,
        ...
        for layer_idx, num_timesteps in enumerate(self.layer_timesteps):
            ...
            for t in range(num_timesteps):
                ...
                #messages.append(self.message_gcn(adj))
                ...
                # a_t = A * W * h_t
                incoming_messages = self.message_gcn(initial_node_representation)
...
#def main():
#    gnn = GatedGraphConvolutionNeuralNetwork(hidden_size=11, num_edge_types=2,
...
#    node_representations = gnn.compute_node_representations(initial_node_representation=torch.randn(4, 11))#,
