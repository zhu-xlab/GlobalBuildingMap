...
def planet_infer_sliding_window(gpuRank, modelFilename, satImg, predDir, predFile, normType=1):
    ...
    if (modelFilename.find('_sr_tsd_') != -1):
        ...
        numChannels = 3
        bfsPNG = predDir + tileDir + '_bm_ss.png'
        bfsTIF = predDir + tileDir + '_bm_ss.tif'
