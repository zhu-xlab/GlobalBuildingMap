...
from .layers import double_conv, up_conv
...
class EfficientUnet(nn.Module):
    def __init__(self, encoder, out_channels=2, concat_input=True, in_channels=4):
        ...
        if self.concat_input:
            ...
            self.double_conv_input = double_conv(
                self.size[4] + in_channels, self.size[5]
            )
        else:
            self.up_conv_input = up_conv(64, self.size[4])
...
def get_efficientunet_b0(
    out_channels=2, concat_input=True, pretrained=True, in_channels=4
):
    encoder = EfficientNet.encoder(
        "efficientnet-b0", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
...
def get_efficientunet_b1(
    ...
    encoder = EfficientNet.encoder(
        "efficientnet-b1", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
        out_channels=out_channels,
...
def get_efficientunet_b2(
    ...
    encoder = EfficientNet.encoder(
        "efficientnet-b2", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
        out_channels=out_channels,
...
def get_efficientunet_b3(
    ...
    encoder = EfficientNet.encoder(
        "efficientnet-b3", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
        out_channels=out_channels,
...
def get_efficientunet_b4(
    ...
    encoder = EfficientNet.encoder(
        "efficientnet-b4", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
        out_channels=out_channels,
...
def get_efficientunet_b5(
    ...
    encoder = EfficientNet.encoder(
        "efficientnet-b5", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
        out_channels=out_channels,
...
def get_efficientunet_b6(
    ...
    encoder = EfficientNet.encoder(
        "efficientnet-b6", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
        out_channels=out_channels,
...
def get_efficientunet_b7(
    ...
    encoder = EfficientNet.encoder(
        "efficientnet-b7", pretrained=pretrained, in_channels=in_channels
    )
    model = EfficientUnet(
        encoder,
        out_channels=out_channels,
