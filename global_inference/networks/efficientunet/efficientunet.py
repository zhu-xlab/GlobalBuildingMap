...
class EfficientUnet(nn.Module):
    def __init__(self, encoder, out_channels=2, concat_input=True,in_channels=4):
        super().__init__()
...
def get_efficientunet_b0(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
...
def get_efficientunet_b1(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
    encoder = EfficientNet.encoder('efficientnet-b1', pretrained=pretrained,in_channels=in_channels)
    model = EfficientUnet(encoder, out_channels=out_channels, concat_input=concat_input,in_channels=in_channels)
    return model


def get_efficientunet_b2(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
    encoder = EfficientNet.encoder('efficientnet-b2', pretrained=pretrained,in_channels=in_channels)
    model = EfficientUnet(encoder, out_channels=out_channels, concat_input=concat_input,in_channels=in_channels)
    return model


def get_efficientunet_b3(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
    encoder = EfficientNet.encoder('efficientnet-b3', pretrained=pretrained,in_channels=in_channels)
    model = EfficientUnet(encoder, out_channels=out_channels, concat_input=concat_input,in_channels=in_channels)
    return model


def get_efficientunet_b4(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
    encoder = EfficientNet.encoder('efficientnet-b4', pretrained=pretrained,in_channels=in_channels)
    model = EfficientUnet(encoder, out_channels=out_channels, concat_input=concat_input,in_channels=in_channels)
    return model


def get_efficientunet_b5(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
    encoder = EfficientNet.encoder('efficientnet-b5', pretrained=pretrained,in_channels=in_channels)
    model = EfficientUnet(encoder, out_channels=out_channels, concat_input=concat_input,in_channels=in_channels)
    return model


def get_efficientunet_b6(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
    encoder = EfficientNet.encoder('efficientnet-b6', pretrained=pretrained,in_channels=in_channels)
    model = EfficientUnet(encoder, out_channels=out_channels, concat_input=concat_input,in_channels=in_channels)
    return model


def get_efficientunet_b7(out_channels=2, concat_input=True, pretrained=True,in_channels=4):
